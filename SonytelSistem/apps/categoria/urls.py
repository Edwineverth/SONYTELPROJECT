...
from .views import crearCategoria,editarCategoria,eliminarCategoria,filtrarCategoria,filtrarAjaxCategoria
urlpatterns = patterns('',
    ...
    url(r'^filtrar/$', filtrarCategoria.as_view(),name='buscar_Categoria'),
