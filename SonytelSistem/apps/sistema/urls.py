...
from .views import index,registrarCliente,reporteCliente,listarCliente,buscarCliente,buscadorAjaxCliente,busqueda,editar,eliminar,filtrarCliente,filtrarAjaxcliente
